...
/** Minimal scaffolding for Laminar-in-JSDOM component tests (ADR-003 Tier 1).
  ...
  * [[io.github.scala_tessella.editor.EditorStateFixture]] — put this trait *last* in the mix-in list so its
  * `afterEach` runs before the state-fixture one (unmount before state restore).
  *

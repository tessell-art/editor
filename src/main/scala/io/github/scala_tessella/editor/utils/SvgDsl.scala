...
object SvgDsl:
  ...
  def polygon(pointsStr: String, fill: String = Defaults.fill, stroke: String = Defaults.stroke, strokeW: String = Defaults.strokeWidthThin): Element =
    svg.polygon(
...
//    s"$fx,$fy"
  ...
  def line(x1: Double, y1: Double, x2: Double, y2: Double, stroke: String = Defaults.stroke, strokeW: String = Defaults.strokeWidthThin): Element =
    svg.line(
      svg.x1 := fmt3(x1),
      svg.y1 := fmt3(y1),
      svg.x2 := fmt3(x2),

...
object Translations:
  ...
  val en: Map[String, String] = Map(
    ...
    "palette.section.recent"           -> "Recently used",
    "palette.handle.title"             -> "Tap to expand or collapse the palette",
    "palette.handle.label"             -> "Shapes",
    "palette.mru.empty.title"          -> "Empty MRU slot — capture a shape with the Shape & Color picker",
    ...
    "palette.tooltip.regularRecentFmt" -> "Regular {0}-gon (recently used)",
  ...
  val es: Map[String, String] = Map(
    ...
    "palette.section.recent"           -> "Recientes",
    "palette.handle.title"             -> "Pulsar para expandir o contraer la paleta",
    "palette.handle.label"             -> "Formas",
    "palette.mru.empty.title"          -> "Espacio vacío — captura una forma con el selector de forma y color",
    "palette.irregular.label"          -> "Irregular",
    ...
    "palette.tooltip.regularRecentFmt" -> "{0}-gono regular (reciente)",

...
object Translations:
  ...
  val en: Map[String, String] = Map(
    ...
    "menu.edit.addCopy.rotate"    -> "Rotate",
    "menu.edit.addCopy.reflect"   -> "Reflect",
    "menu.edit.addCopy.glide"     -> "Glide reflect",
    ...
    "modeBadge.glideReflectCopy" -> "Glide reflect copy",
  ...
  val es: Map[String, String] = Map(
    ...
    "menu.edit.addCopy.rotate"    -> "Girar",
    "menu.edit.addCopy.reflect"   -> "Reflejar",
    "menu.edit.addCopy.glide"     -> "Reflejar y deslizar",
    ...
    "modeBadge.glideReflectCopy" -> "Reflejar y deslizar copia",

...
/** Single source of truth for menu accelerator labels.
  *
  * Both [[art.tessell.editor.components.MenuBarComponent]] (DOM menu hints) and the Tauri native menu read
  * from this table so the two can't drift; parity between this file and

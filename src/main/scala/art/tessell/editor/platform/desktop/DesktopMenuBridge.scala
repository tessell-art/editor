package art.tessell.editor.platform.desktop

import art.tessell.editor.AppState
import art.tessell.editor.models.EditorState
import art.tessell.editor.operations.{UndoManager, ViewOperations}
import art.tessell.editor.utils.Logger
import art.tessell.editor.utils.file.{DotExporter, SvgExporter}
import org.scalajs.dom

import scala.scalajs.js

/** Subscribes to the Tauri native menu's "menu" event and dispatches each item id to the same AppState /
  * EditorState entry point the DOM menu in [[art.tessell.editor.components.MenuBarComponent]] already uses.
  *

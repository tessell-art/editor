...
import art.tessell.editor.components.popup.{
  AboutPopup, GuidePopup, IrregularPolygonPopup, PrintPopup, RecentFilesPopup, SettingsPopup, ShortcutsPopup,
  TemplateGalleryPopup, UnsavedChangesPopup
}
import art.tessell.editor.i18n.{I18n, Locale}
